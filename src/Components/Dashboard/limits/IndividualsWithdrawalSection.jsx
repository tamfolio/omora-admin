...
const IndividualsWithdrawalSection = ({ individualsWithdrawalLimits, setIndividualsWithdrawalLimits }) => {
  return (
    <div className="bg-white border border-[#E9EAEB] rounded-lg overflow-hidden">
      <div className="px-6 py-5 border-b border-[#E9EAEB]">
        <h2 className="text-lg font-semibold text-[#181D27]">Individuals</h2>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#E9EAEB]">
              ...
              <th className="text-left text-sm font-medium text-[#717680] px-6 py-3">Daily Transaction Limit</th>
              <th className="text-left text-sm font-medium text-[#717680] px-6 py-3">Single Transaction Limit</th>
              <th className="text-left text-sm font-medium text-[#717680] px-6 py-3">Applicable to</th>
            </tr>
          </thead>
          <tbody>
            {individualsWithdrawalLimits.map((limit, index) => (
                  ...
                  <td className="px-6 py-4">
                    <div className="relative">
                      ...
                      >
                        ...
                        <option>Specific Individuals</option>
                      </select>
                      <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none" />
                    </div>
                  </td>
                </tr>
                {limit.applicableTo === "Specific Individuals" && limit.specificCustomers.length > 0 && (
                  <tr className={index === individualsWithdrawalLimits.length - 1 ? "" : "border-b border-[#E9EAEB]"}>
                    <td colSpan="3" className="border-r border-[#E9EAEB]"></td>
                    <td className="px-6 py-4">
...
export default IndividualsWithdrawalSection;
