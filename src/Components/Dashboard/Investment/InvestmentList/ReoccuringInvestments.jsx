...
function RecurringInvestments() {
  ...
  const handleInvestmentClick = (investmentId) => {
    navigate(`/dashboard/recurring-investments/${investmentId}`);
  };
  ...
  const recurringInvestmentsData = [
    {
      ...
      investmentCategory: "Conservative",
      balance: "USD $10.00",
      status: "Active",
    },
    {
  ...
  const filteredData = recurringInvestmentsData.filter(
    (investment) =>
