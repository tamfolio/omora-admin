...
function ResumeInvestmentModal({ isOpen, onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80  flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-96 shadow-xl">
        <h2 className="text-xl font-semibold text-gray-900 mb-6 text-center">Resume Investment</h2>
...
export default ResumeInvestmentModal;