...
const ProviderInfo = ({ provider }) => {
  const recentLogsData = [
    { endpoint: '401', response: '401', timestamp: '12:00pm', date: '15th July, 2025' },
    { endpoint: '500', response: '500', timestamp: '12:00pm', date: '15th July, 2025' },
    { endpoint: '500', response: '500', timestamp: '12:00pm', date: '15th July, 2025' },
    { endpoint: '500', response: '500', timestamp: '12:00pm', date: '15th July, 2025' },
    { endpoint: '500', response: '500', timestamp: '12:00pm', date: '15th July, 2025' },
    { endpoint: '500', response: '500', timestamp: '12:00pm', date: '15th July, 2025' },
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4">
      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gray-50 rounded-lg p-3">
              <div className="text-xs text-gray-600 mb-1">Uptime (24h uptime)</div>
        ...
        {/* Latest Incidents */}
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <h4 className="text-base font-medium text-gray-900 mb-3">Latest Incidents</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {incidentsData.map((incident, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-3">
                <div className="font-medium text-xs text-gray-900 mb-1">{incident.type}</div>
                <div className="text-xs text-gray-600 mb-1">Root Cause: {incident.rootCause}</div>
                <div className="text-xs text-gray-600 mb-1">Resolution: {incident.resolution}</div>
      ...
      <div className="w-full lg:w-80">
        <div className="bg-white rounded-lg border border-gray-200 p-4 flex flex-col h-full">
          <h3 className="text-base font-medium text-gray-900 mb-3">Recent Logs</h3>
          ...
          <div className="flex flex-col flex-1">
            ...
            <div className="space-y-1.5 overflow-y-auto flex-1">
              {recentLogsData.map((log, index) => (
                <div key={index} className="grid grid-cols-3 gap-2 py-1 text-xs border-b border-gray-100 last:border-b-0">
