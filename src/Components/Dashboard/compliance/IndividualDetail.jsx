...
import { createIndividualData, transactionData, investmentData, auditData } from "./utils/mockData";
...
const IndividualDetail = () => {
  ...
  const handleResetKYC = () => {
    console.log("Reset KYC for individual:", id);
    // Add your reset KYC logic here
  };

  const handleSuspendAccount = () => {
    console.log("Suspend account for individual:", id);
    // Add your suspend account logic here
  };

  const handleDownloadKYC = () => {
    console.log("Download KYC for individual:", id);
  ...
  const individualData = createIndividualData(id);
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "Profile Details":
        return (
          <div>
            <ProfileDetailsSection individualData={individualData} />
          </div>
        );
  ...
  return (
    <div>
      ...
      <div className="flex items-center space-x-2 text-sm text-gray-600 mb-4">
        ...
        <span className="text-[#717680] font-semibold">Individual</span>
        <ChevronRight size={16} color="#A4A7AE" />
        <span>...</span>
        <ChevronRight size={16} color="#A4A7AE" />
